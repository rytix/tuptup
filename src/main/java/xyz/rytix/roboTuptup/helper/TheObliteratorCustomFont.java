/**
 * Meus eternos agradescimentos ao TheObliterator,
 * Cujo seu trabalho ajudou a facilitar MUITO a minha vida :)
 */
 ...
 */
public class TheObliteratorCustomFont {
         ...
         */
        public TheObliteratorCustomFont(Minecraft mc, Object font, int size)
        {
         ...
         */
        public TheObliteratorCustomFont(Minecraft mc, Object font, int size, int startChar, int endChar)
        {
