...
//XXX
public class ScratchBlocoRepita2 extends ScratchBlocoInstrucoesInternas{
	private int repita = 0;
	private final int REPITCOUNT = 2;
	public ScratchBlocoRepita2(GuiBaseRoboTela gui, int left, int top, boolean ehUmBlocoExemplo) {
		super(gui, left, top, new Class[]{ScratchBlocoString.class}, true, true, true, ehUmBlocoExemplo);
		addBlocoNaAssinatura(new ScratchBlocoString(this, gui, "Repita 2 vezes", left, top), 0);
	}
