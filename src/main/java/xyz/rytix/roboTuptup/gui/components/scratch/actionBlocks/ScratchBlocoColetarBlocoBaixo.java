...
public class ScratchBlocoColetarBlocoBaixo extends ScratchBlocoAction{

	public ScratchBlocoColetarBlocoBaixo(GuiBaseRoboTela gui, int left, int top, boolean exemplo) {
		super(gui, left, top, "Coletar Abaixo", exemplo);
		color = 0xFF995BA5;
